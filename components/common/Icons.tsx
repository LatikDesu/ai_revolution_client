	...
	>
		<g fill='currentColor' clipPath='url(#a)'>
			<path
				...
				clipRule='evenodd'
			/>
			<path d='M0 11h14v2H0zM8 5h2v2H8zM10 7h2v2h-2zM12 9h2v2h-2zM8 17h2v2H8zM10 15h2v2h-2zM12 13h2v2h-2zM14 11h2v2h-2z' />
		</g>
		<defs>
			<clipPath id='a'>
				<path fill='#fff' d='M0 0h24v24H0z' />
...
export const Send: React.FC<Props> = ({ className, ...rest }) => (
	...
	>
		<g fill='currentColor' clipPath='url(#a)'>
			<path d='M0 .667h1.412V4H0V.667ZM5.647 8h1.412v8H5.647V8ZM7.059 9.334V8h2.823v1.334H7.06ZM9.882 8V6.667h2.824V8H9.882ZM12.706 6.667V5.332h2.823v1.333h-2.823ZM22.588.667H24V4h-1.412V.667Z' />
